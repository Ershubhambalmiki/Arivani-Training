                        ...
                        <div className='flex relative '>
                            ...
                            <div className='' style={{ position: "absolute", right: 10 }}>
                                <span onClick={() => setShowPassword(!showPassword)}>
                                    {showPassword ? <i className="fa-solid fa-eye mt-4 " ></i> : <i className="fa-solid fa-eye-slash mt-4"></i>}
                                </span>
                        ...
                        <div className='flex relative'>
                            ...
                            <div style={{ position: "absolute", right: 10 }}>
                                <button type='button' onClick={() => setShowCnfPassword(!showCnfPassword)}>
                                    {showCnfPassword ? <i className="fa-solid fa-eye mt-4 " ></i> : <i className="fa-solid fa-eye-slash mt-4"></i>}
                                </button>
                            </div>
                        </div>
